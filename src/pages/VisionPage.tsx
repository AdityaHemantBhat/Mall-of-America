...
const infrastructureMatrix = [
  {
    ...
    label: "MSP Transit",
    value: "12 MIN",
    detail: "Direct Link to Intl Hub",
  },
  {
    icon: TrainFront,
    label: "Light Rail",
    value: "ON-SITE",
    detail: "Blue Line Terminus",
  },
  {
    icon: Hotel,
    label: "Hospitality",
    value: "3,000+",
    detail: "Connected Room Keys",
  },
  {
    icon: Route,
    label: "Catchment",
    value: "30M",
    detail: "1-Day Drive Radius",
  },
];
            ...
            <div className="lg:col-span-5">
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span className="text-moa-gold text-[10px] md:text-xs font-bold tracking-[0.5em] uppercase">
                    Strategic Thesis
                  </span>
                </div>
                ...
                <p className="text-white/50 text-base md:text-xl font-light leading-relaxed mb-12 border-l border-white/10 pl-8">
                  Mall of America is a self-contained economic ecosystem. We
                  have redefined the boundaries of retail, creating a
                  high-density environment where brands don't just exist—they
                  dominate.
                </p>

                <div className="grid grid-cols-2 gap-8">
                  <div>
                    <span className="text-white/20 text-[9px] font-mono block mb-2 uppercase tracking-widest">
                      System_Status
                    </span>
      ...
      <section className="py-24 md:py-40 bg-[#040404] reveal-container">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="mb-20">
            ...
            <h2 className="font-display text-4xl md:text-6xl text-white tracking-tighter uppercase">
              The Competitive{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 border border-white/5">
            {strategicAssets.map((asset, i) => (
              <div
                key={i}
                className="reveal-item bg-moa-black p-12 relative group hover:bg-zinc-900/50 transition-colors duration-500 overflow-hidden"
              >
                <div className="absolute top-0 right-0 p-8 opacity-[0.03] group-hover:opacity-10 transition-opacity">
                  <asset.icon size={120} />
                </div>
                <span className="text-moa-gold/40 text-[9px] font-mono mb-8 block">
                  {asset.id}
                </span>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div>
              ...
              <p className="text-white/50 text-base md:text-xl font-light leading-relaxed mb-12 max-w-xl">
                Strategically positioned at the nexus of international air
                travel and regional high-speed transit, Mall of America is the
                most accessible commercial destination in North America.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-8">
              {infrastructureMatrix.map((item, i) => (
                <div
                  key={i}
                  className="p-8 border border-white/5 bg-zinc-900/20 rounded-2xl group hover:border-moa-gold/30 transition-all"
                >
                  <item.icon
                    className="text-moa-gold mb-6 group-hover:scale-110 transition-transform"
                    size={24}
                  />
                  <div className="text-white/20 text-[9px] font-mono uppercase tracking-widest mb-2">
                    {item.label}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          >
            <h2 className="font-display text-5xl md:text-8xl text-white tracking-tighter uppercase mb-12">
              Ready to <br />
              <span className="text-moa-gold italic">Partner?</span>
            </h2>
            <p className="text-white/40 text-lg md:text-xl font-light max-w-2xl mx-auto mb-16">
              Connect with our strategic partnership team to integrate your
              brand into the most high-performance retail environment in the
              world.
            </p>
