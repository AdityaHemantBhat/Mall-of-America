    ...
    <div className="bg-moa-black min-h-screen">
      ...
      <section className="py-24 md:py-40 bg-moa-black relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div>
              <span className="text-moa-gold text-[10px] font-mono tracking-[0.5em] uppercase mb-8 block">
                Audience Insight
              </span>
              ...
              <p className="text-white/50 text-base md:text-xl font-light leading-relaxed max-w-xl">
                Every sponsorship is engineered for maximum conversion. We
                provide brands with unfiltered access to 40 million affluent
                visitors spending an average of 4.3 hours per visit.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-white/5 border border-white/5">
              {deploymentMetrics.map((item, i) => (
                <div
                  key={i}
                  className="p-8 bg-zinc-900/10 hover:bg-zinc-900/40 transition-colors group"
                >
                  <item.icon
                    className="text-moa-gold opacity-30 group-hover:opacity-100 transition-opacity mb-6"
                    size={20}
                  />
      ...
      <section className="py-24 md:py-40 border-t border-white/5 bg-[#060606]">
        <div className="max-w-screen-2xl mx-auto px-6">
          <div className="text-center mb-24">
            <span className="text-moa-gold text-[10px] font-mono tracking-[0.5em] uppercase mb-6 block">
            ...
            {sponsorshipMatrix.map((t, i) => (
              <div
                ...
                className={cn(
                  ...
                  t.highlight
                    ? "border-moa-gold bg-moa-gold/5 shadow-[0_0_40px_rgba(212,175,55,0.05)]"
                    : "border-white/5 bg-zinc-900/20 hover:border-white/20",
                )}
              >
                <div className="text-moa-gold font-mono text-[10px] tracking-widest uppercase mb-4">
                  {t.id}
                </div>
                <h3 className="text-white font-display text-4xl mb-2 uppercase">
                  {t.name}
                </h3>
                <p className="text-white/30 text-[10px] font-bold uppercase tracking-[0.2em] mb-12">
                  {t.tagline}
                </p>
                <ul className="space-y-6 mb-16 flex-1">
                  {t.features.map((f, j) => (
                    <li
                      key={j}
                      className="flex items-start gap-4 text-white/50 text-sm font-light leading-snug"
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-moa-gold shrink-0 mt-1.5" />
                      {f}
                    </li>
                  ))}
                </ul>
                <button
                  className={cn(
                    ...
                    t.highlight
                      ? "bg-moa-gold text-black hover:bg-white"
        ...
        <div className="max-w-screen-2xl mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            ...
            <div className="bg-moa-gold/10 border border-moa-gold/20 px-6 py-4 rounded-sm flex items-center gap-4">
              ...
              <span className="text-[10px] font-mono text-moa-gold tracking-widest uppercase">
                Verified Results
              </span>
            </div>
          </div>
            ...
            {briefings.map((c, i) => (
              ...
              >
                <div className="md:col-span-1 mb-6 md:mb-0">
                  <span className="text-moa-gold/30 font-mono text-[10px] group-hover:text-moa-gold transition-colors">
                    0{i + 1}
                  </span>
                </div>

                <div className="md:col-span-4 mb-6 md:mb-0">
                  <h3 className="text-white font-display text-3xl md:text-5xl uppercase mb-2 group-hover:text-moa-gold transition-colors">
                    {c.brand}
                  </h3>
                  <div className="flex items-center gap-3">
                    <span className="w-8 h-px bg-moa-gold/40" />
                    <span className="text-moa-gold text-xs font-mono tracking-[0.2em] font-bold uppercase">
                      {c.result}
                    </span>
                  </div>
                </div>
          ...
          <div className="mt-20 flex flex-col items-center">
            <div className="text-[9px] font-mono text-white/10 uppercase tracking-[1em] mb-8">
              Next Steps
            </div>
            <div className="w-px h-24 bg-linear-to-b from-moa-gold/50 to-transparent" />
          </div>
        </div>
      </section>
      ...
      <section className="relative py-32 md:py-48 overflow-hidden border-t border-white/5">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-t from-moa-black via-moa-black/80 to-moa-black" />
        </div>

        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-5xl md:text-9xl text-white tracking-tighter uppercase mb-12">
            Secure Your <br />
            <span className="text-moa-gold italic">Partnership.</span>
          </h2>
          <p className="text-white/40 text-lg md:text-xl font-light max-w-2xl mx-auto mb-16">
            Contact our strategic partnership desk to build a high-performance
            campaign at the most visited destination in North America.
          </p>
