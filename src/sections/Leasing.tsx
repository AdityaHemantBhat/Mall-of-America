...
export function Leasing() {
  return (
    <section id="leasing" className="relative w-full bg-moa-black py-32 overflow-hidden border-t border-white/5">
      <div className="max-w-screen-xl mx-auto px-6">
        ...
        <div className="mb-20">
          ...
          <p className="text-white/30 text-sm font-light mt-6 max-w-lg leading-relaxed">
            Flexible positioning for brands of every scale. Whether you're planting a permanent flag or running a 60-day activation, there's a structure built for it.
          </p>
        </div>
        ...
        <div className="space-y-5">
          {tiers.map((item, i) => (
            <motion.div
              ...
              className={`grid grid-cols-1 lg:grid-cols-12 gap-8 p-10 rounded-2xl border transition-colors duration-300 group ${item.highlight
            ...
            >
              <div className="lg:col-span-3">
                ...
                <div className="text-moa-gold font-mono text-[11px] tracking-widest uppercase mb-1">{item.size}</div>
                <div className="text-white/25 text-[10px] font-mono uppercase tracking-wider">{item.location}</div>
              </div>

              <div className="lg:col-span-5">
                <div className="text-white/20 text-[9px] font-mono uppercase tracking-widest mb-3">Overview</div>
                <p className="text-white/50 text-sm leading-relaxed">{item.details}</p>
              </div>

              <div className="lg:col-span-4">
                <div className="text-white/20 text-[9px] font-mono uppercase tracking-widest mb-4">Included</div>
        ...
        <div className="mt-16 border-t border-white/5 pt-10 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          <p className="text-white/20 text-sm font-light max-w-md leading-relaxed">
            Availability is limited by design. Reach out to our leasing team to check current inventory and discuss co-tenancy strategy.
          </p>
