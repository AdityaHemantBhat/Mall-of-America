  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1800px] mx-auto flex items-center justify-between">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 left-0 w-full h-px bg-moa-gold origin-left"
            />
          </button>
          ...
          <div className="hidden xl:flex items-center space-x-10">
            {siteData.nav.map((item) => (
              ...
              >
                ...
                <motion.div className="h-px bg-moa-gold w-0 group-hover:w-full transition-all duration-300 mt-1" />
              </button>
            ))}
          </div>
              ...
              <div className="flex flex-col items-end space-y-1.5 transition-all duration-300">
                <span
                  className={cn(
                    ...
                    mobileMenuOpen
                      ? "w-6 rotate-45 translate-y-[2px] bg-moa-gold"
                      : "w-6",
                  )}
                />
                <span
        ...
        <div
          className="absolute bottom-0 left-0 h-px bg-moa-gold/30 transition-all duration-300"
          id="global-progress"
          style={{ width: "0%" }}
        />
      </nav>
              ...
              <div className="flex flex-col space-y-6 md:space-y-8 w-full xl:w-auto items-center xl:items-start text-center xl:text-left">
                {siteData.nav.map((item, i) => (
                  ...
                  >
                    ...
                    >
                      <span className="hidden xl:block opacity-0 group-hover:opacity-100 transition-opacity absolute -left-12 text-xl font-sans text-moa-gold">
                        0{i + 1}
                      </span>
              ...
              >
                <div className="flex flex-col items-center xl:items-end">
                  ...
                  <div className="flex gap-8 xl:flex-col xl:gap-2">
                    <p className="text-white text-xs md:text-sm hover:text-moa-gold cursor-pointer transition-colors">
                      Instagram
                    </p>
                    <p className="text-white text-xs md:text-sm hover:text-moa-gold cursor-pointer transition-colors">
                      LinkedIn
                ...
                <div className="text-center xl:text-right">
                  ...
                  <p className="text-white text-sm md:text-lg font-medium break-all">
      ...
      {location.pathname === "/" && (
        <div className="fixed right-6 lg:right-12 top-1/2 -translate-y-1/2 z-40 hidden md:flex flex-col items-end space-y-8">
          {[
            ...
            >
              <span className="text-[9px] font-bold tracking-[0.3em] uppercase text-white/20 group-hover:text-moa-gold transition-colors opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 duration-500">
                {slide.label}
              </span>
