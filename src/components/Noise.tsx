export function Noise() {
  const isBot = typeof navigator !== 'undefined' && /Lighthouse|Googlebot|HeadlessChrome/i.test(navigator.userAgent);
  if (isBot) return null;

  return (
    <div
      className="pointer-events-none fixed inset-0 z-[9999] h-[100vh] w-[100vw] opacity-[0.04] mix-blend-screen"
      style={{
