        ...
        >
          ...
          >
            <div className="hidden md:block md:w-[45%] relative border-r border-white/10">
              <img
                loading="lazy"
                src="/images/moa_venue_executive_suite_1777708464860.png"
                alt="Executive Suite"
              ...
              <div className="absolute bottom-12 left-12">
                <div className="text-moa-gold text-[10px] font-mono tracking-[0.2em] uppercase mb-2">
                  Connect
                </div>
                <div className="text-white font-display text-2xl uppercase tracking-widest">
                  Private
                  <br />
                  Briefing
                </div>
            ...
            <div className="flex-1 relative z-10 w-full p-8 md:p-16">
              ...
              <h2 className="font-display text-4xl lg:text-5xl text-white leading-[1.1] tracking-tighter uppercase mb-6">
                Let's Discuss <br />
                <span className="text-moa-gold italic">Opportunities.</span>
              </h2>

              <p className="text-white/40 text-sm font-light max-w-md mb-12 leading-relaxed">
                Connect with our leasing team to explore flagship spaces,
                experiential pop-ups, or massive brand activations. Tell us a
                bit about your brand, and we'll get back to you to schedule a
                private tour.
              </p>
              ...
              <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="relative group">
                    <input
                      type="text"
                      id="name"
                      className="w-full bg-transparent border-b border-white/20 pb-4 text-white text-sm focus:outline-none focus:border-moa-gold transition-colors peer placeholder-transparent"
                      placeholder="Your Name"
                    />
                    <label
                      htmlFor="name"
                      className="absolute left-0 top-0 text-[10px] uppercase font-mono text-white/40 tracking-widest transition-all peer-focus:-translate-y-5 peer-focus:text-moa-gold peer-focus:text-[9px] peer-placeholder-shown:translate-y-0 peer-placeholder-shown:text-white/40"
                    >
                      Your Name
                    </label>
                  </div>
                ...
                <div className="relative group">
                  <select
                    id="type"
                    className="w-full bg-transparent border-b border-white/20 pb-4 text-white text-sm focus:outline-none focus:border-moa-gold transition-colors appearance-none cursor-pointer"
                  >
                    <option
                      value=""
                      disabled
                      selected
                      className="bg-[#0c0a09] text-white/40"
                    >
                      What are you looking for?
                    </option>
                    <option className="bg-[#0c0a09]">
                  ...
                  <label
                    htmlFor="type"
                    className="absolute left-0 -top-5 text-[9px] uppercase font-mono text-moa-gold tracking-widest"
                  >
                    Inquiry Type
                  </label>
                ...
                <div className="pt-8 flex items-center justify-between border-t border-white/10 mt-8">
                  <button
                    type="button"
                    onClick={onClose}
                    className="text-white/50 hover:text-white uppercase text-[10px] tracking-widest font-bold transition-colors"
                  >
                    Cancel
                  </button>
